 ...
 * Incluye el logo, selector de idioma y botón de inicio de sesión
 */
const Navbar = () => {
  ...
  return (
    <header className="relative z-10 w-full">
      <div className="container mx-auto px-4 py-6 flex items-center justify-between">
        ...
        {/* Versión escritorio - Selector de idioma y botón de inicio de sesión */}
      ...
      {/* Menú móvil */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-black/95 p-4 flex flex-col gap-4 border-t border-gray-800">
          <div className="flex items-center gap-1 border rounded-md px-2 py-1 w-fit">
            <Globe size={16} />
            <span className="text-sm">Español</span>
            <ChevronDown size={16} />
          </div>
          
          <Button className="bg-[#e50914] hover:bg-[#f40612] text-white w-full">
            Iniciar sesión
          </Button>
        </div>
      )}
