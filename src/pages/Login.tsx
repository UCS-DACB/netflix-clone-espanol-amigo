...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Inicio de sesión con:", { email, password, rememberMe });
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex flex-col" 
      style={{
        backgroundImage: `url('https://assets.nflxext.com/ffe/siteui/vlv3/93da5c27-be66-427c-8b72-5cb39d275279/6de58cc5-c02c-45d0-a1e2-def9a7b8af89/ES-es-20240226-popsignuptwoweeks-perspective_alpha_website_medium.jpg')`
      }}>
      ...
      <header className="relative z-10 w-full">
        <div className="container mx-auto px-4 py-6">
          <Link to="/" className="flex-shrink-0">
            <svg viewBox="0 0 111 30" className="h-8 w-24 fill-[#e50914]" aria-hidden="true" focusable="false">
              <g id="netflix-logo">
      ...
      <main className="flex-grow flex items-center justify-center relative z-10">
        <div className="bg-black/75 p-16 rounded-md w-full max-w-md mx-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                className="w-full p-4 rounded bg-[#333] text-white border-none"
                value={email}
            ...
            <Button type="submit" className="w-full bg-[#e50914] hover:bg-[#f40612] text-white py-3">
              Iniciar sesión
            </Button>
          ...
          <div className="mt-16">
            <p className="text-[#b3b3b3]">
              ¿Primera vez en Netflix? <Link to="/" className="text-white hover:underline">Suscríbete ya</Link>.
            </p>
      ...
      <div className="relative z-10 bg-black/75 mt-auto">
        <Footer />
      </div>
    </div>
  );
